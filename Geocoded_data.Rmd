...
wvs_sub$id <- do.call(paste0, expand.grid(LETTERS[1:18], 1:4879))
...
Q11B - How often something stolen from home
...
#which( colnames(afro_sub2)=="source" )
...
df3 =merge(x=df ,y=df2,by="source",all=TRUE) #merges by source 

#to check if all went smoothly
table(df3$source)
...
#rearange id variable 
df3 <- df3[,c(1, 11, 8, 9, 10, 2:7,  12:ncol(df3))] 
